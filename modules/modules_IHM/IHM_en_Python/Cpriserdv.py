...
class Ui_Form(object):
    def __init__(self, arg):
        self.dico = arg[0]                  #Le premier élément du tuple envoyé par le serveur à la génération de l'IHM est un dictionnaire rempli d'une liste de type de praticiens en clé avec pour chaqu'une de ces clés le type de rendez-vous que le médecin peut faire
    ...
    def setupUi(self, Form):                #Mise en place de l'IHM
        ...
        self.ValidationpushButton.released.connect(lambda: self.set_date_rdv(self.jourLineEdit.text(),self.moisLineEdit.text(),self.anneeLineEdit.text()))      #Le bouton Validation renvoie le jour, le mois et l'année rentrés dans la zone de texte LineEdit dans self.jour_rdv, self.mois_rdv, self.annee_rdv au moyen de la fonction set_date_rdv()
