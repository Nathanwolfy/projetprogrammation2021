...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        item = QtWidgets.QTableWidgetItem()
        self.EdTtableWidget.setItem(1, 1, item)
    ...
    def retranslateUi(self, Form):
        ...
        item = self.EdTtableWidget.verticalHeaderItem(0)
        item.setText(_translate("Form", "New Row"))
        item = self.EdTtableWidget.verticalHeaderItem(1)
        item.setText(_translate("Form", "New Row"))
        item = self.EdTtableWidget.verticalHeaderItem(2)
        item.setText(_translate("Form", "New Row"))
        item = self.EdTtableWidget.verticalHeaderItem(3)
        item.setText(_translate("Form", "New Row"))
        item = self.EdTtableWidget.verticalHeaderItem(4)
        item.setText(_translate("Form", "New Row"))
        item = self.EdTtableWidget.verticalHeaderItem(5)
        item.setText(_translate("Form", "New Row"))
        item = self.EdTtableWidget.verticalHeaderItem(6)
        item.setText(_translate("Form", "New Row"))
        item = self.EdTtableWidget.verticalHeaderItem(7)
        item.setText(_translate("Form", "New Row"))
        item = self.EdTtableWidget.verticalHeaderItem(8)
        item.setText(_translate("Form", "New Row"))
        item = self.EdTtableWidget.verticalHeaderItem(9)
        item.setText(_translate("Form", "New Row"))
        item = self.EdTtableWidget.verticalHeaderItem(10)
        item.setText(_translate("Form", "New Row"))
        item = self.EdTtableWidget.verticalHeaderItem(11)
        item.setText(_translate("Form", "New Row"))
        ...
        item = self.EdTtableWidget.item(1, 1)
        item.setText(_translate("Form", "nique ta mere"))
